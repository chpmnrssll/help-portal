...
RUN git clone https://${GITHUB_TOKEN}@github.com/chpmnrssll/demo-content.git /demo-content/
...
RUN git clone https://${GITHUB_TOKEN}@github.com/chpmnrssll/static-output.git /static-output/
